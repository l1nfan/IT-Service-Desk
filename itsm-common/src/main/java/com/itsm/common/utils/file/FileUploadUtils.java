package com.itsm.common.utils.file;
...
import com.itsm.common.exception.file.FileNameLengthLimitExceededException;
import com.itsm.common.exception.file.FileSizeLimitExceededException;
import com.itsm.common.exception.file.InvalidExtensionException;
import com.itsm.common.utils.DateUtils;
import com.itsm.common.utils.StringUtils;
import com.itsm.common.utils.uuid.IdUtils;
import com.itsm.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ItsmConfig.getProfile();
    ...
    {
        int dirLastIndex = ItsmConfig.getProfile().length() + 1;
