package com.itsm.common.utils.poi;
...
import com.itsm.common.annotation.Excel.ColumnType;
import com.itsm.common.annotation.Excel.Type;
import com.itsm.common.annotation.Excels;
import com.itsm.common.config.ItsmConfig;
import com.itsm.common.core.domain.AjaxResult;
import com.itsm.common.core.text.Convert;
import com.itsm.common.exception.UtilException;
import com.itsm.common.utils.DateUtils;
import com.itsm.common.utils.DictUtils;
import com.itsm.common.utils.StringUtils;
import com.itsm.common.utils.file.FileTypeUtils;
import com.itsm.common.utils.file.FileUtils;
import com.itsm.common.utils.file.ImageUtils;
import com.itsm.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        ...
        {
            ClientAnchor anchor = new XSSFClientAnchor(0, 0, 0, 0, cell.getColumnIndex(), cell.getRow().getRowNum(), cell.getColumnIndex() + 1, cell.getRow().getRowNum() + 1);
    ...
    {
        String downloadPath = ItsmConfig.getDownloadPath() + filename;
